...
export default function Button({ innerText, urlSound, disabled }) {
    ...
    return (
        <button disabled={disabled} id={innerText} onClick={playSound} className="drum-pad m-2 bg-gray-200 text-2xl text-blue-700 font-bold hover:bg-blue-400 active:bg-green-500 hover:text-white border border-blue-400 w-14 h-14 sm:w-24 sm:h-24 rounded-lg shadow-md" >
